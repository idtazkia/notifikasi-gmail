...
public class NotifikasiGmailApplicationTests {
	...
	public void testSendGmail() throws Exception {
        String emailContent = StreamUtils.copyToString(mailTemplate.getInputStream(),
                Charset.forName("UTF-8"));

        gmailApiService.send("endy@tazkia.ac.id", "Selamat Datang di Aplikasi Notifikasi", emailContent);
    }
